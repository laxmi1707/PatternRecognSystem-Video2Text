...
|--------|---------|------------|-----------|
| feat/* | Individual feature work. Each member works here daily. | Local only | None (author pushes freely) |
| develop | Integration branch. All members merge here to test together. | dev environment | 1 approver required |
| release/* | Release candidate. Frozen for UAT testing before presentations. | uat environment | 2 approvers required |
| main | Production-ready. Only verified, tested code lives here. | stg, prd environments | 2 approvers required |
...
- If Joshua's frontend and Muneeswaran's backend break each other, we catch it in develop, not production
- develop auto-deploys to the dev environment for testing
- main always stays clean and working
- Lecturers/supervisors see a stable main branch at all times
...
### How Each Member Works
    ...
    #    - Create PR from develop to release/v0.2.0
...
| Branch | Direct Push | Min Approvers | Stale Reviews Dismissed |
|--------|------------|---------------|------------------------|
| main | Blocked | 2 | Yes |
| develop | Blocked | 1 | Yes |
| feat/* | Allowed | 0 | N/A |
